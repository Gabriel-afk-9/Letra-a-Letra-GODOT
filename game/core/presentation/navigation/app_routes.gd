...
const MAIN := "res://features/main/presentation/views/main_screen.tscn"
...
const SOCIAL := "res://features/social/presentation/views/social_screen.tscn"
const ROOMS := "res://features/rooms/presentation/views/rooms_screen.tscn"
const ROOM := "res://features/room/presentation/views/room_lobby_screen.tscn"
const MATCHMAKING := "res://features/matchmaking/presentation/views/matchmaking_screen.tscn"
const GAME := "res://features/game/presentation/views/game_screen.tscn"
